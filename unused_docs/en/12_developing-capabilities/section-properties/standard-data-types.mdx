...
would be to write an [Inline Loader](https://docs.deco.cx/en/developing-guide/fetching-data)
...
- [Fetching data](https://docs.deco.cx/en/developing-guide/fetching-data)
