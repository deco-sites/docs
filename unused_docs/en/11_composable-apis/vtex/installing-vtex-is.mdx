...
[Loaders](https://deco.cx/docs/en/concepts/loader) available in
...
> [here](https://deco.cx/docs/en/tutorials/connecting-vtex)
...
VTEX Intelligent Search in your [Sections](https://deco.cx/docs/en/concepts/page) and
[Pages](https://deco.cx/docs/en/concepts/page).
