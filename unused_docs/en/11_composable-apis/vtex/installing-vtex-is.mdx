...
[Loaders](https://docs.deco.cx/en/concepts/loader) available in
...
> [here](https://docs.deco.cx/en/tutorials/connecting-vtex)
...
VTEX Intelligent Search in your [Sections](https://docs.deco.cx/en/concepts/page) and
[Pages](https://docs.deco.cx/en/concepts/page).
