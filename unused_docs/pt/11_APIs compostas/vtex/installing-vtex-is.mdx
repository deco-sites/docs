...
dos [Loaders](https://docs.deco.cx/pt/concepts/loader) disponíveis em
...
> [aqui](https://docs.deco.cx/en/tutorials/connecting-vtex)
...
<Frame><img width="847" alt="image" src="https://user-images.githubusercontent.com/18706156/225157818-47f5da0e-dfa7-4ad8-9d79-818370baba55.png"/></Frame>

**É isso!** Agora você pode usar os Loaders da _deco.cx_ que buscam dados da
Intelligent Search em suas [Sections](https://docs.deco.cx/pt/concepts/section) e
[Pages](https://docs.deco.cx/pt/concepts/page).
