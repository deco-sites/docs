...
![Visualização do banco de dados no admin](https://deco.cx/docs/reference/deco-records/records-view.webp)
...
![Visualização do botão de gerar credenciais](https://deco.cx/docs/reference/deco-records/generate-credentials.webp)
...
![Visualização das tabelas do deco records](https://deco.cx/docs/reference/deco-records/records-view-tables.webp)
