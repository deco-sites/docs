...
![Instalar app](/images/getting-started/adding-an-app/install-app.png)
...
![Página de Seções](/images/getting-started/adding-an-app/sections-page.png)
...
![Selecionar Fonte de Temperatura](/images/getting-started/adding-an-app/select-source.png)

Você tem três opções:

1. **Entrada Manual**: Forneça um número arbitrário para a temperatura.

   ![Entrada Manual](/images/getting-started/adding-an-app/manual-entry.png)
...
2. **Valor Padrão**: Deixe o campo de temperatura em branco. A seção aceita um
   ...
   ![Valor Padrão](/images/getting-started/adding-an-app/default-value.png)

3. **Usar o Loader**: Utilize o loader disponibilizado pelo Weather App.

   ![Usar o Loader](/images/getting-started/adding-an-app/use-loader.png)
   ...
   ![Temperatura do Loader](/images/getting-started/adding-an-app/loader-temperature.png)
...
em [um tutorial anterior](https://docs.deco.cx/pt/getting-started/creating-a-new-page). É isso!
