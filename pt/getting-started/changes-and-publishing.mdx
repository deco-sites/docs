---
title: Gerenciando Mudanças e Publicando
...
![Mudanças no Ambiente](/images/getting-started/changing-and-publishing/env-changes.png)
...
![Rebase no ambiente](/images/getting-started/changing-and-publishing/rebase.png)
