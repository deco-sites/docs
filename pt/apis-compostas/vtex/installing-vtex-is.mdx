...
dos [Loaders](https://deco.cx/docs/pt/concepts/loader) disponíveis em
...
> [aqui](https://deco.cx/docs/en/tutorials/connecting-vtex)
...
Intelligent Search em suas [Sections](https://deco.cx/docs/pt/concepts/section) e
[Pages](https://deco.cx/docs/pt/concepts/page).
