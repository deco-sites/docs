...
<Frame><img width="640" alt="Configuração do tema com fontes" src="https://deco.cx/docs/performance/theme-font.png"/></Frame>
...
<Frame><img width="320" alt="Uso de temas próprios" src="https://deco.cx/docs/performance/custom-font.png"/></Frame>
