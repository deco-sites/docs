...
[documentation](https://deco.cx/docs/en/developing-capabilities/apps/ab-test).
...
[documentation](https://deco.cx/docs/en/developing-capabilities/apps/ab-test#funnel-and-results).
