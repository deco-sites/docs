...
[documentation](https://docs.deco.cx/en/developing-capabilities/apps/ab-test).
...
[documentation](https://docs.deco.cx/en/developing-capabilities/apps/ab-test#funnel-and-results).
