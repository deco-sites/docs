...
would be to write an [Inline Loader](https://deco.cx/docs/en/developing-guide/fetching-data)
...
- [Fetching data](https://deco.cx/docs/en/developing-guide/fetching-data)
