...
| `@format`           | Configures a field to be formatted differently. This can cause its [Widget](https://docs.deco.cx/en/developing-capabilities/section-properties/widgets) to change.                                                                                                                                                                            | `@format [Format value](#possible-values-for-format)`                |
...
| `@options`          | Required for the operation of the [dynamic options](https://docs.deco.cx/pt/developing-capabilities/section-properties/widgets#dynamic-options), [button group](https://docs.deco.cx/pt/developing-capabilities/section-properties/widgets#button-group) and [icon select](https://docs.deco.cx/pt/developing-capabilities/section-properties/widgets#icon-select) widgets. | `@options deco-sites/mystore/loaders/products.ts`                    |
...
- `@format dynamic-options`:
  [Read about it here](https://docs.deco.cx/en/developing-capabilities/section-properties/widgets#dynamic-options).
