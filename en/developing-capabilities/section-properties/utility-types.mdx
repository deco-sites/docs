...
- [Core Concepts: Section](https://docs.deco.cx/en/concepts/section)
- [Coding a new Section](https://docs.deco.cx/en/developing-guide/hello-world)

You already know that it's easy to create a configurable
[Section](https://docs.deco.cx/en/concepts/section) on _deco.cx_. In this post we'll outline
...
<Frame><img width="640" alt="Section Form" src="/images/dev-capabilities/utility-types/section-form.png"/></Frame>
...
<Frame><img width="640" alt="Section form with customized label and description" src="/images/dev-capabilities/utility-types/label-and-description.png"/></Frame>
...
the
[annotations doc](https://docs.deco.cx/en/developing-capabilities/section-properties/annotations).
