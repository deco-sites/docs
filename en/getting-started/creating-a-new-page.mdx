...
![Pages space](https://deco.cx/docs/getting-started/creating-a-new-page/pages-space.png)
...
![Creating a new page](https://deco.cx/docs/getting-started/creating-a-new-page/new-page.png)
...
![Adding a section](https://deco.cx/docs/getting-started/creating-a-new-page/add-section.png)

> If you want to develop/code a new Section, check our
> [Developing Guide](https://deco.cx/docs/en/developing-guide/setup).

Here, we will select the Hero section.

![Hero section](https://deco.cx/docs/getting-started/creating-a-new-page/hero.png)
...
![Section Form](https://deco.cx/docs/getting-started/creating-a-new-page/section-form.png)
...
![Changing Section](https://deco.cx/docs/getting-started/creating-a-new-page/changing-section.png)
