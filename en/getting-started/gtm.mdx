...
![Selecting the site app](/images/gtm/select-app.png)

Next, locate the global sections properties:

![Global Sections](/images/gtm/global-sections.png)

Finally, add the Analytics section:

![Adding Analytics section](/images/gtm/add-analytics.png)
...
![Configuring your section](/images/gtm/configure-your-section.png)
