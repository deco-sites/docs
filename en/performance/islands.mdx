...
When loading data from external APIs using [Loaders](https://docs.deco.cx/en/concepts/loader)
and sending them to the [Section](https://docs.deco.cx/en/concepts/section), it is possible
...
<Frame><img width="640" alt="Performance information of a page" src="/images/performance/performance-tab.png"/></Frame>
