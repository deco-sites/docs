...
Segments are defined by [Matchers](https://deco.cx/docs/en/concepts/matchers), which evaluate
...
context of [Variants](https://deco.cx/docs/en/getting-started/variants). Variants enable you to
