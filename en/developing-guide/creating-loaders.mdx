...
> Important: When authoring a loader, set a cache policy and `cacheKey`. See
...
![DogFacts section in the Admin](https://deco.cx/docs/developing-guide/creating-loaders/dog-facts-section.png)
