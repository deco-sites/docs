...
that into a Section using [Loaders](https://deco.cx/docs/en/concepts/loader).

> Important: Always cache your loaders and provide a stable `cacheKey`. See
> [Caching data loaders](https://deco.cx/docs/en/performance/caching-data-loaders).
...
<Frame><img width="1512" alt="Section rendering data fetched from API" src="https://user-images.githubusercontent.com/18706156/225758802-7277e774-921d-46e5-b384-bc9245b8eef1.png"/></Frame>

_Preview of DogFacts Section showing data returned from API_

<Frame><img width="941" alt="Data returned from the Dog Facts API" src="https://user-images.githubusercontent.com/18706156/225752374-0882d0ec-966b-4074-a49d-d18ffc17d8b9.png"/></Frame>
...
- [Standard data types](https://deco.cx/docs/en/developing-capabilities/section-properties/standard-data-types)
- [Core Concepts: Loaders](https://deco.cx/docs/en/concepts/loader)
