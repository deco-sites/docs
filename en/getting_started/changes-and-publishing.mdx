...
![Environment Changes](https://deco.cx/docs/getting-started/changing-and-publishing/env-changes.png)
...
![Rebase environment](https://deco.cx/docs/getting-started/changing-and-publishing/rebase.png)
