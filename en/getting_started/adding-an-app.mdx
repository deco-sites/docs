...
![Install app](https://deco.cx/docs/getting-started/adding-an-app/install-app.png)
...
![Sections Page](https://deco.cx/docs/getting-started/adding-an-app/sections-page.png)
...
![Select Temperature Source](https://deco.cx/docs/getting-started/adding-an-app/select-source.png)

You have three options:

1. **Manual Entry**: Provide an arbitrary number for the temperature.

   ![Manual Entry](https://deco.cx/docs/getting-started/adding-an-app/manual-entry.png)
...
2. **Default Value**: Leave the temperature field blank. The section accepts a
   ...
   ![Default Value](https://deco.cx/docs/getting-started/adding-an-app/default-value.png)

3. **Use the Loader**: Utilize the loader made available by the Weather App.

   ![Use the Loader](https://deco.cx/docs/getting-started/adding-an-app/use-loader.png)
   ...
   ![Loader Temperature](https://deco.cx/docs/getting-started/adding-an-app/loader-temperature.png)
...
[a previous tutorial](https://deco.cx/docs/en/getting-started/creating-a-new-page). That's it!
