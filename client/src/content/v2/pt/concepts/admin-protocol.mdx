...
Todos vivem em `@decocms/blocks-admin` e são plugados no worker via `createDecoWorkerEntry`.
...
- Tipos widget de `@decocms/blocks/types/widgets` → controles de UI customizados.
