...
É o que [Casa&Vídeo faz](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/src/setup.ts) — as 3 primeiras sections eager, tudo abaixo defere.
...
Deploys em produção não têm esse problema. Veja [`ssr-optimization-framework.md`](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/docs/ssr-optimization-framework.md) do Casa&Vídeo para a investigação completa.
</Callout>
