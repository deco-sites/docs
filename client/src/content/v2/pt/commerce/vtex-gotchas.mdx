...
Veja [`sortwhitelist.ts`](/Users/fernandofrizzatti/development/workspace/decocms/apps-start/src/vtex/utils/sortwhitelist.ts) para a lista exata.
...
Veja [`vtex-checkout-proxy.ts`](/Users/fernandofrizzatti/development/workspace/decocms/lebiscuit-tanstack/src/middleware/vtex-checkout-proxy.ts) do Le biscuit para o padrão certo.
...
- [Estudo de caso Le biscuit](/v2/pt/case-studies/lebiscuit)
