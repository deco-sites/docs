...
description: "createVtexCommerceLoaders, formato amigável ao CMS, slugCache, sortwhitelist."
icon: "Workflow"
---
...
Aí use `customLoaders` em `getCommerceLoaders`. Veja [`commerce-loaders.ts` do Casa&Vídeo](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/src/setup/commerce-loaders.ts) para um wrapper de produção real.
...
Bagaggio usa; Casa e Le biscuit não. A diferença é como tunar quando o tamanho do bundle vira gargalo.
