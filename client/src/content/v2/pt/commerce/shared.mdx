...
Reduz CLS frente a injeção crua de `<script>`. Veja [`cls-pending-issues.md`](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/docs/cls-pending-issues.md) do Casa&Vídeo para análise dos tradeoffs.
