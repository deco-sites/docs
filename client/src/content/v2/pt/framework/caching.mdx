...
Profiles default (extraídos de [`cacheHeaders.ts`](/Users/fernandofrizzatti/development/workspace/decocms/deco-start/src/sdk/cacheHeaders.ts)):
...
Veja [`cache-config.ts` do Casa&Vídeo](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/src/cache-config.ts) para um exemplo real de override em larga escala.
...
Veja [`vtex-fetch-cache.ts`](/Users/fernandofrizzatti/development/workspace/decocms/apps-start/src/vtex/sdk/vtex-fetch-cache.ts) em `@decocms/apps` para a versão de fetch (`vtexFetchWithCache`).
...
- [Estudo de caso Casa&Vídeo](/v2/pt/case-studies/casaevideo)
