...
`@decocms/blocks/hooks` exporta componentes e hooks React que conectam dados resolvidos do CMS à página. O carro-chefe é `DecoPageRenderer`; o resto preenche em volta.
