...
Um shell `__root.tsx` pré-pronto. Casa&Vídeo e Le biscuit usam; Bagaggio prefere o próprio.
...
Faça o seu se precisar de mais controle. Veja [`__root.tsx` do Bagaggio](/Users/fernandofrizzatti/development/workspace/decocms/baggagio-tanstack/src/routes/__root.tsx) para um custom.
...
O padrão mais seguro é usar `useDevice` num loader de section (server-only) e passar como prop. Veja [`cls-pending-issues.md`](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/docs/cls-pending-issues.md) do Casa&Vídeo para a investigação.
</Callout>
