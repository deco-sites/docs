...
3. **[Script de migração](/v2/pt/migration/migrate-script)** — o que `npx -p @decocms/start deco-migrate` faz.
...
| Site pequeno, controle total | Port manual — clonar [`lebiscuit-tanstack`](https://github.com/deco-sites/lebiscuit-tanstack) e migrar sections na mão. |
...
As lojas de referência estão fixadas nessas ou perto — veja [`lebiscuit-tanstack/package.json`](/Users/fernandofrizzatti/development/workspace/decocms/lebiscuit-tanstack/package.json).
