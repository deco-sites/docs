...
description: "O que npx -p @decocms/start deco-migrate faz de fato."
icon: "Terminal"
---
...
Vindo de [`scripts/migrate.ts`](/Users/fernandofrizzatti/development/workspace/decocms/deco-start/scripts/migrate.ts):
...
Um exemplo real vive em [`baggagio-tanstack/MIGRATION_REPORT.md`](/Users/fernandofrizzatti/development/workspace/decocms/baggagio-tanstack/MIGRATION_REPORT.md).
