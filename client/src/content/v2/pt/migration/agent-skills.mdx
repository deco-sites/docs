...
`@decocms/blocks` traz um Agent Skill — um prompt estruturado + conjunto de referência — pensado para ferramentas de IA de coding (Claude Code, Cursor, Codex etc.). Depois de instalado, você pode dizer *"migre este projeto para TanStack Start"* e ele cuida da cauda longa de ajustes manuais.
...
- **Consultar docs** — quando não sabe algo, lê os docs de `@decocms/blocks` antes de chutar.
...
O bundle (em [`decocms/blocks/.agents/skills/deco-to-tanstack-migration/`](https://github.com/decocms/blocks/tree/main/.agents/skills/deco-to-tanstack-migration)) contém:
...
<Callout type="info">
O skill anda **com o framework**. Versões novas de `@decocms/blocks` podem incluir atualizações de skill. Re-rode `npx skills add decocms/blocks` depois de atualizar o framework no projeto (ou antes de começar uma migração nova num projeto novo).
</Callout>
