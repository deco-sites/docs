...
Para lojas pequenas (< 30 sections) ou times que querem controle total, siga a receita de [Começar do zero](/v2/pt/getting-started/start-fresh) para criar à mão o esqueleto mínimo do projeto e leve suas sections, components e conteúdo de `.deco/blocks/` para lá.
