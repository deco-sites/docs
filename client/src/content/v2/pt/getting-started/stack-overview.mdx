...
├─────────────────────────────────────────────────┤
│   @decocms/blocks  (framework)                    │  ← Bridge do CMS, protocolo do admin, worker entry, cache
└─────────────────────────────────────────────────┘
              ↓ roda em ↓
   TanStack Start  +  React 19  +  Cloudflare Workers
```

### Camada 1: `@decocms/blocks` — framework
...
O que você toca mais: `cmsRouteConfig` e `loadCmsPage` de `@decocms/tanstack` para URLs guiadas pelo CMS.
