...
Esta página leva você do zero até uma loja v2 em produção, criando à mão o conjunto mínimo de arquivos que `@decocms/blocks` e `@decocms/apps-*` precisam para subir.
...
- `@decocms/blocks ^2.x` — framework + ponte para o CMS.
