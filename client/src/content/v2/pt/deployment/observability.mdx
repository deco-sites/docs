...
Veja [HyperDX skill](https://github.com/decocms/deco-start/tree/main/.agents/skills) para o setup canônico em produção da deco.cx.
...
Casa&Vídeo usa Sentry; veja [`apps-start.config.ts`](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront) para integração.
