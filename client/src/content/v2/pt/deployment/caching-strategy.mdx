...
Veja [`cache-config.ts` do Casa&Vídeo](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/src/cache-config.ts) para overrides em larga escala em loja real.
