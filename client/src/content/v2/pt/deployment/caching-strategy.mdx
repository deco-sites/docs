...
Veja [skill `deco-variant-selection-perf`](https://github.com/decocms/blocks/tree/main/.agents/skills) para o padrão.
...
Sem isso, Header re-resolve em cada page load e dispara chamada de "shelves de products no header" para VTEX em cada hop de URL. Veja [skill `deco-cms-layout-caching`](https://github.com/decocms/blocks/tree/main/.agents/skills) para a investigação.
...
`@decocms/blocks` adiciona `x-deco-cache: profile=pdp;ttl=300;state=fresh` para profile + TTL aplicado.
