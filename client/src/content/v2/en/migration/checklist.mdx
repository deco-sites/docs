...
- [ ] If you used a region-aware fetch in v1, port it (see [Casa&Video example](/Users/fernandofrizzatti/development/workspace/decocms/casaevideo-storefront/src/setup.ts)).
