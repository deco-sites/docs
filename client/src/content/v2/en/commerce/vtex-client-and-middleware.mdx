...
GET-only. Routes through `fetchWithCache` from [`vtex/utils/fetchCache.ts`](/Users/fernandofrizzatti/development/workspace/decocms/apps-start/vtex/utils/fetchCache.ts):
