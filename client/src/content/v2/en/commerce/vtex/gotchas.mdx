...
For legacy catalog calls (which don't pass through `vtexFetch`), wrap a custom region-aware fetch — see [Region-aware fetch](/v2/en/commerce/vtex/client-and-middleware#region-aware-fetch-advanced).
