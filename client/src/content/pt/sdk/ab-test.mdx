...
outra [documentação](https://docs.deco.cx/pt/developing-capabilities/apps/ab-test).
...
[documentação](https://docs.deco.cx/pt/developing-capabilities/apps/ab-test#funil-e-resultado).
