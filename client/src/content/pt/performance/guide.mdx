...
**Guia**: [Otimizando imagens](https://docs.deco.cx/pt/performance/medias/images)
...
**Guia**: [Otimizando SVGs](https://docs.deco.cx/pt/performance/medias/svg-sprites)
...
**Guia**: [Otimizando fontes](https://docs.deco.cx/pt/performance/medias/fonts)
...
**Guia**: [Otimizando scripts](https://docs.deco.cx/pt/performance/lazy-3rd-party-scripts)
...
**Guia**: [Otimizando loaders](https://docs.deco.cx/pt/performance/loaders)
...
**Guia**: [Otimizando ilhas](https://docs.deco.cx/pt/performance/islands)
