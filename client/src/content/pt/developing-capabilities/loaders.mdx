...
dados necessários em uma [Section](https://docs.deco.cx/pt/concepts/section). Essas funções são
...
é possível [Instalar novas apps](https://docs.deco.cx/pt/getting-started/adding-an-app) que
...
[Sections](https://docs.deco.cx/pt/concepts/section). Isso significa que os usuários de negócio
...
mesmo tipo de dados**. Isso permite que as [Sections](https://docs.deco.cx/pt/concepts/section)
...
UIs podem ser reutilizadas em [Sites](https://docs.deco.cx/pt/getting-started/creating-a-site) ou entre times,
...
![image](https://user-images.githubusercontent.com/18706156/224897214-a45b2731-5799-4007-8084-a8a772ddf5d2.png)
...
- [Buscando dados de API](https://docs.deco.cx/pt/developing-guide/fetching-data)
- [Invocando um loader através da API](https://docs.deco.cx/pt/developing-capabilities/islands/fetching-data-client)
