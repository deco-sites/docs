...
Segmentos são definidos por [Matchers](https://docs.deco.cx/pt/concepts/matchers), que avaliam
...
contexto de [Variants](https://docs.deco.cx/pt/getting-started/variants). Variantes permitem
