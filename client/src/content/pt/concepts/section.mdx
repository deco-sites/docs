...
[Instalar novas apps](https://docs.deco.cx/pt/getting-started/adding-an-app).
...
- [Tutorial: Codificando uma nova seção](https://docs.deco.cx/pt/developing-guide/hello-world)
- [Desenvolvendo: Seções personalizáveis](https://docs.deco.cx/pt/developing-guide/editable-sections)
