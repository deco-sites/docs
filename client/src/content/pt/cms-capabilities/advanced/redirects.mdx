...
![Redirects view](/images/cms-capabilities/redirects/redirects1.png)
...
![Add redirect form](/images/cms-capabilities/redirects/redirects2.png)
...
![Configure site app](/images/cms-capabilities/redirects/proxies1.png)

### 2. Procure peloRoutes Map

Procure no formulário de edição do app, pela propriedade de routes map.

![Configure site app](/images/cms-capabilities/redirects/proxies2.png)
