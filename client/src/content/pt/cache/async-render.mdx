...
[Partials](https://docs.deco.cx/pt/developing-capabilities/interactive-sections/partial) para
...
[`LoadingFallback` em nossa documentação](https://docs.deco.cx/pt/developing-capabilities/sections/loading-fallback).
