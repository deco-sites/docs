...
é possível [Instalar novas apps](https://docs.deco.cx/pt/getting-started/installing-an-app) que
...
UIs podem ser reutilizadas em [Sites](https://docs.deco.cx/pt/concepts/site) ou entre times,
...
- [Buscando dados de API](https://docs.deco.cx/pt/develping/fetching-data)
