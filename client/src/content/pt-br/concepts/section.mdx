...
[Instalar novas apps](https://docs.deco.cx/pt/getting-started/installing-an-app).
...
- [Tutorial: Codificando uma nova seção](https://docs.deco.cx/en/developing-guide/hello-world)
- [Desenvolvendo: Seções personalizáveis](https://docs.deco.cx/en/developing-guide/editable-sections)
