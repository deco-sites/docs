...
![Componente image como uma imagem de produto](/images/image-aspect-ratio.png)

- `<Picture>` define imagens que podem variar de tamanho de acordo com a
  resolução de tela.

![Componente de Picture como uma imagem de banner](/images/picture-aspect-ratio.png)
...
3. Passe o mouse sobre a tag da imagem. Você deverá ver algo como:
   ![Propriedades da imagem no inspetor do navegador](/images/width-attribute.png)
