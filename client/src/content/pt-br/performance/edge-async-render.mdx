...
[Partials](https://docs.deco.cx/en/developing-capabilities/interactive-sections/partial) para
...
[`LoadingFallback` em nossa documentação](https://docs.deco.cx/en/developing-capabilities/sections/loading-fallback).
