...
![Selecionando o app do site](/images/gtm/select-app.png)

Em seguida, localize as propriedades das sections globais:

![Sections Globais](/images/gtm/global-sections.png)

Por fim, adicione a section de Analytics:

![Adicionando section de Analytics](/images/gtm/add-analytics.png)
...
![Configurando sua section](/images/gtm/configure-your-section.png)
