---
title: "Buscando dados no cliente"
...
- [Conceitos básicos: Loader](https://docs.deco.cx/pt/concepts/loader)
- [Conceitos básicos: Action](https://docs.deco.cx/pt/concepts/action)
