...
![Formulário da Section no Admin](/images/dev-capabilities/utility-types/section-form.png)
...
![Formulário da Section com label e descrição costumizadas](/images/dev-capabilities/utility-types/label-and-description.png)
