---
title: Newsletter with HTMX and Deco Records
description: Newsletter with HTMX and Deco Records
since: 1.0.0
...
2. Configure [Deco Records](https://docs.deco.cx/en/developing-capabilities/deco-records)
...
1. `newsletterSubscribe.tsx`: Newsletter subscription form (email field) +
   inline [action](https://docs.deco.cx/en/concepts/action) that performs the
