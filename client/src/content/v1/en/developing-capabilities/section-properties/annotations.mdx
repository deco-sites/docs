...
| `@options`          | Required for the operation of the [dynamic options](https://docs.deco.cx/en/developing-capabilities/section-properties/widgets#dynamic-options), [button group](https://docs.deco.cx/en/developing-capabilities/section-properties/widgets#button-group) and [icon select](https://docs.deco.cx/en/developing-capabilities/section-properties/widgets#icon-select) widgets. | `@options deco-sites/mystore/loaders/products.ts`                    |
