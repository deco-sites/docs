...
After removing the old records, wait a few minutes for DNS to propagate and the new certificate to be issued — the new entry will show **Active** once that's done and the migration will be complete.
