...
If any address is returned, remove that AAAA record at your DNS provider. The deco.cx apex-redirect service uses IPv4 only — no AAAA record should be present on the apex domain.
