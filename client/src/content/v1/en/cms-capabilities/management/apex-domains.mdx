...
Once it's Active, identify the old entry — it's the one that shows a **Revalidate domain** button and, if you expand its **DNS records** section, lists the old Deno Deploy IPs (`34.120.54.55`). Open the `…` menu on that entry and choose **Delete**.
