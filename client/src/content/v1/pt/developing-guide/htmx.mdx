...
É aí que o [hook `useSection`](https://docs.deco.cx/pt/api-reference/use-section) é útil. Este
...
![Requisições da versão HTMX](/images/developing-guide/htmx/htmx-network.gif)

![Requisições da versão Preact](/images/developing-guide/htmx/preact-network.gif)
...
e a [documentação do deco.cx](https://docs.deco.cx/pt/getting-started/overview).
