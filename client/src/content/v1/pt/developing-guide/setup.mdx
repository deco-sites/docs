...
de criar [Sections](https://docs.deco.cx/pt/concepts/section) e
[Loaders](https://docs.deco.cx/pt/concepts/loader) que atendem às suas necessidades exclusivas.
...
Siga o tutorial de
[Criar um Site Deco](https://docs.deco.cx/pt/getting-started/creating-a-site).
...
![Adicionando colaborador no repositório](/images/setup/repository-access.png)
...
![Criar novo ambiente](/images/setup/create-environment.png)

#### 3.2 Defina o nome e o host do seu ambiente

Escolha um nome para o seu ambiente e defina seu host como localhost.

![Definindo nome e host do ambiente](/images/setup/choose-host.png)
...
![Comando de iniciar server](/images/setup/start-server-command.png)

![Iniciando server no terminal](/images/setup/start-server-terminal.png)
...
![Publicar mudanças](/images/setup/publish-button.png)
