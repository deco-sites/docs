---
title: Newsletter com HTMX e Deco Records
...
2. Configurar o [Deco Records](https://docs.deco.cx/pt/developing-capabilities/deco-records)
...
1. `newsletterSubsbribe.tsx`: Formulário de inscrição na Newsletter (campo de
   e-mail) + [action](https://docs.deco.cx/pt/concepts/action) inline que
