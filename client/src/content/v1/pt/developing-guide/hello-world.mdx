...
[setup](https://docs.deco.cx/pt/developing-guide/setup). Ao selecionar seu ambiente local no
Admin, você poderá visualizar a nova Section na biblioteca de Sections
(**Sections**) e adicioná-la a uma página.

![Nova section na section library](/images/hello-world/new-section.png)
...
[essas anotações aqui](https://docs.deco.cx/pt/developing-capabilities/section-properties/widgets)
...
![Formulário da section no admin](/images/hello-world/section-properties.png)
...
![Alterando as cores do tema](/images/hello-world/themes.png)
...
![Escolhendo o tema de uma página](/images/hello-world/add-section.png)

![Alterando o tema de uma página](/images/hello-world/section-themes.png)
...
![Adicionando o tema Groovy Vibes](/images/hello-world/page-theme.png)
...
![Section com tema do site](/images/hello-world/new-section-with-theme.png)
