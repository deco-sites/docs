...
![Arquitetura Deployment](/images/self-host/architecture.png)
...
![Arquitetura Self-host site](/images/self-host/self-host-site.png)
...
![Arquitetura Self-host de Site e Envs](/images/self-host/self-host-envs.png)
