...
Segmentos são definidos por [Matchers](https://docs.deco.cx/pt/concepts/matcher), que avaliam
...
contexto de [Variants](https://docs.deco.cx/pt/cms-capabilities/advanced/segments). Variantes permitem
