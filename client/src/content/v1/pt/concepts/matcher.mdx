...
fundamental ao potencializar as [Variants](https://docs.deco.cx/pt/cms-capabilities/advanced/segments).
...
**Matcher Block**, você pode chamá-lo de [Segmento](https://docs.deco.cx/pt/concepts/segment).
