...
Quando estiver Active, identifique a entrada antiga — é a que exibe o botão **Revalidate domain** e, ao expandir a seção **DNS records**, mostra os IPs antigos do Deno Deploy (`34.120.54.55`). Abra o menu `…` nessa entrada e escolha **Excluir**.
