...
Após remover os registros antigos, aguarde alguns minutos para o DNS propagar e o novo certificado ser emitido — a nova entrada passará a exibir **Active** assim que isso ocorrer e a migração estará concluída.
