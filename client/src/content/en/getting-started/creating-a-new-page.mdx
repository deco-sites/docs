...
![Pages space](/images/getting-started/creating-a-new-page/pages-space.png)
...
![Creating a new page](/images/getting-started/creating-a-new-page/new-page.png)
...
![Adding a section](/images/getting-started/creating-a-new-page/add-section.png)

> If you want to develop/code a new Section, check our
> [Developing Guide](https://docs.deco.cx/en/developing-guide/setup).

Here, we will select the Hero section.

![Hero section](/images/getting-started/creating-a-new-page/hero.png)
...
![Section Form](/images/getting-started/creating-a-new-page/section-form.png)
...
![Changing Section](/images/getting-started/creating-a-new-page/changing-section.png)
