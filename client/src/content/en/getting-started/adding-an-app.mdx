...
![Install app](/images/getting-started/adding-an-app/install-app.png)
...
![Sections Page](/images/getting-started/adding-an-app/sections-page.png)
...
![Select Temperature Source](/images/getting-started/adding-an-app/select-source.png)

You have three options:

1. **Manual Entry**: Provide an arbitrary number for the temperature.

   ![Manual Entry](/images/getting-started/adding-an-app/manual-entry.png)
...
2. **Default Value**: Leave the temperature field blank. The section accepts a
   ...
   ![Default Value](/images/getting-started/adding-an-app/default-value.png)

3. **Use the Loader**: Utilize the loader made available by the Weather App.

   ![Use the Loader](/images/getting-started/adding-an-app/use-loader.png)
   ...
   ![Loader Temperature](/images/getting-started/adding-an-app/loader-temperature.png)
...
[a previous tutorial](https://docs.deco.cx/en/getting-started/creating-a-new-page). That's it!
