...
![alt text](/images/headless-cms/change-flow.png)
...
![Home page store front](/images/headless-cms/site.png)
...
![JSON response on request with ?asJson query](/images/headless-cms/asjson.png)
