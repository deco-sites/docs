...
![Section rendering data fetched from API](https://user-images.githubusercontent.com/18706156/225758802-7277e774-921d-46e5-b384-bc9245b8eef1.png)

_Preview of DogFacts Section showing data returned from API_

![Data returned from the Dog Facts API](https://user-images.githubusercontent.com/18706156/225752374-0882d0ec-966b-4074-a49d-d18ffc17d8b9.png)
