...
![HTMX installation in the deco Admin](/images/developing-guide/htmx/htmx-installation.png)
...
That's when the [`useSection` hook](https://docs.deco.cx/en/api-reference/use-section) comes in
...
![HTMX request in the network tab](/images/developing-guide/htmx/htmx-network.gif)

![Preact request in the network tab](/images/developing-guide/htmx/preact-network.gif)
...
and [deco.cx documentation](https://docs.deco.cx/en/getting-started/overview).
