...
flexibility to create [Sections](https://docs.deco.cx/en/concepts/section) and
[Loaders](https://docs.deco.cx/en/concepts/loader) that meet their unique needs. To help you
...
[Creating a Site tutorial](https://docs.deco.cx/en/getting-started/creating-a-site).
...
![Adding collaborator to the repository](/images/setup/repository-access.png)
...
![Create new environment](/images/setup/create-environment.png)

#### 3.2 Set a name and a host to your environment

Choose a name for your environment and set your host as localhost.

![Choosing environment and starting server](/images/setup/choose-host.png)
...
![Start server command](/images/setup/start-server-command.png)

![Execute command on terminal](/images/setup/start-server-terminal.png)
...
![Publish changes](/images/setup/publish-button.png)
