...
you created in a [previous tutorial](https://docs.deco.cx/en/getting-started/creating-a-site).
...
![Hero Section Code](/images/editable-section/hero-section-code.png)
...
![Editing properties of the Hero Section](/images/editable-section/section-props.png)

**Section and its properties types**

## 2. Run your site locally

Follow the [environment configuration](https://docs.deco.cx/en/developing-guide/setup) steps
...
[Widget documentation](https://docs.deco.cx/en/developing-capabilities/section-properties/widgets).

Let's add a CTA button in our Hero section to see the modification:

![CTA Button Example](/images/editable-section/cta-button-example.png)

Now the CTA has the size field:

![CTA Size Field](/images/editable-section/cta-size-field.png)
...
![CTA Button Size Adjustment](/images/editable-section/cta-button-size-adjustment.gif)
