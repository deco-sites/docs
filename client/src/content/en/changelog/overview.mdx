...
import Update from "../../../components/ui/Update.astro";
import Callout from "../../../components/ui/Callout.astro";

<Update label="February 2025">
## 🎉 Celebrating 1000 PRs on deco-cx/apps! 🎉

    ![Form Selection](/images/changelog/2025-jan-rjsf.png) 
...
<Update label="January 2025">
  ...
  ## AI Input form fill
    ![AI Inputs](/images/changelog/2025-jan-aiinput.png) 
  ...
  ## Webdrawm in admin
    ![Webdraw](/images/changelog/2025-jan-webdraw.png) 
    ...
    <Callout type="warning">Note: This feature is still experimental!</Callout>
