...
![Section Form](/images/dev-capabilities/utility-types/section-form.png)
...
![Section form with customized label and description](/images/dev-capabilities/utility-types/label-and-description.png)
