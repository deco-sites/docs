...
[Installing apps](https://docs.deco.cx/en/getting-started/installing-an-app) that contain
loaders.
...
can be reused across [Sites](https://docs.deco.cx/en/concepts/site) or across teams, making it
