...
needed in a [Section](https://docs.deco.cx/en/concepts/section). These functions are executed
...
[Installing apps](https://docs.deco.cx/en/getting-started/adding-an-app) that contain
loaders.
...
[Admin](https://deco.cx/admin) just like [Sections](https://docs.deco.cx/en/concepts/section).
...
return the same data type**. This allows [Sections](https://docs.deco.cx/en/concepts/section)
...
can be reused across [Sites](https://docs.deco.cx/en/getting-started/creating-a-site) or across teams, making it
...
- [Fetching data from APIs](https://docs.deco.cx/en/developing-guide/fetching-data)
- [Client-side function invocation](https://docs.deco.cx/en/developing-capabilities/islands/fetching-data-client)
