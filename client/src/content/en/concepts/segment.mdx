...
Segments are defined by [Matchers](https://docs.deco.cx/en/concepts/matcher), which evaluate
...
context of [Variants](https://docs.deco.cx/en/cms-capabilities/advanced/segments). Variants enable you to
