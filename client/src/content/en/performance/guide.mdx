...
<Callout type="info">
  deco offers components like `Image` that help accelerate the
</Callout>
...
<Callout type="warning">
  the most important thing (the golden rule) is the user
</Callout>
...
**Guide**: [Optimizing images](https://docs.deco.cx/en/performance/medias/images)

<Callout type="tip">
  Use deco image components, such as `<Image>` and `<Picture>`, and
</Callout>
...
**Guide**: [Optimizing SVGs](https://docs.deco.cx/en/performance/medias/svg-sprites)
...
**Guide**: [Optimizing fonts](https://docs.deco.cx/en/performance/medias/fonts)

<Callout type="tip">
  Use standard fonts offered by Google. If necessary, use smaller fonts
</Callout>
...
**Guide**: [Optimizing scripts](https://docs.deco.cx/en/performance/lazy-3rd-party-scripts)

<Callout type="tip">
  Try to only use what is strictly necessary or replace third-party
</Callout>
...
**Guide**: [Optimizing loaders](https://docs.deco.cx/en/performance/loaders)
...
**Guide**: [Optimizing islands](https://docs.deco.cx/en/performance/islands)
