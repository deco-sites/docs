...
**Guide**: [Optimizing images](/images/performance/medias/images)
...
**Guide**: [Optimizing SVGs](/images/performance/medias/svg-sprites)
...
**Guide**: [Optimizing fonts](/images/performance/medias/fonts)
...
**Guide**: [Optimizing scripts](/images/performance/lazy-3rd-party-scripts)
...
**Guide**: [Optimizing loaders](/images/performance/loaders)
...
**Guide**: [Optimizing islands](/images/performance/islands)
