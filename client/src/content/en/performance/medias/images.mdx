...
![Image component as a product image](/images/image-aspect-ratio.png)

- `<Picture>` defines images that can vary in size according to the screen
  resolution.

![Picture component as a banner image](/images/picture-aspect-ratio.png)
...
3. Hover over the image tag. You should see something like:
   ![Image properties in the browser inspector](/images/width-attribute.png)
...
<Callout type="tip">
  The final page should have only <u>one preloaded image</u>.
</Callout>
