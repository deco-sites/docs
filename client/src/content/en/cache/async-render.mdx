...
[Partials](https://docs.deco.cx/en/developing-capabilities/interactive-sections/partial)
...
![Stale Edge Cache](/images/performance/stale-edge-cache.png)
...
[`LoadingFallback` component in our documentation](https://docs.deco.cx/en/developing-capabilities/sections/loading-fallback).
