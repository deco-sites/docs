...
outra [documentação](https://deco.cx/docs/pt/developing-capabilities/apps/ab-test).
...
[documentação](https://deco.cx/docs/pt/developing-capabilities/apps/ab-test#funil-e-resultado).
