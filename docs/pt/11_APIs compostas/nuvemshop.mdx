...
[guia](https://deco.cx/docs/pt-br/getting-started/creating-a-site) para criar um.

> Certifique-se de que seu site foi criado com base no modelo **Store
> Nuvemshop** abaixo:

<Frame><img width="386" alt="Criando um website no deco.cx" src="https://github.com/deco-cx/apps/assets/76620866/f94bbf9a-e109-43a7-87ad-5ffd94c1701b"/></Frame>
...
3. Selecione o App da **Nuvemshop**. Você verá algo como:
   <Frame><img width="480" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/5a52d192-cb60-4f84-9be6-9dcc00a1056e"/></Frame>
...
5. Após isso, você verá um botão para pegar o Store Id e o Access Token. Clique
   ...
   da Nuvemshop.
   <Frame><img width="180" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/761ccfa2-074f-40c7-a40d-0e7852ea1341"/></Frame>

6. Após, você verá um Pop-up como esse no painel da Nuvemshop:
   <Frame><img width="250" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/2dd205f5-8f76-42f0-b596-dea45ebaad0f"/></Frame>

7. Clique em `Aceitar e começar a usar`

8. Enfim, você será redirecionado para uma tela com o Store Id e Access Token:
   <Frame><img width="250" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/56b33ede-5d5e-4ef5-a307-421bb0f06c7b"/></Frame>
...
3. Selecione o bloco `ProductShelf` e clique no botão `+`.
   <Frame><img width="180" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/cbd54a38-3caf-431f-aeaf-b8eb2548626e"/></Frame>

4. No campo `products`, selecione a integração Nuvemshop.
   <Frame><img width="234" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/70bf9588-adea-41ee-b87f-ba62b986d057"/></Frame>

5. Preencha o campo `term` com uma busca, por exemplo, "chá".

6. Preencha o campo `limit` com o número de produtos a serem exibidos,
   digamos 4.
   <Frame><img width="349" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/ac48586a-bf40-4551-bcfe-686a4f48149c"/></Frame>

7. Agora, no canto superior direito, clique em `Criar` e dê um nome, por
   exemplo, `Coleção 1`.
   <Frame><img width="577" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/42afa077-2260-4521-bced-ae7f26792838"/></Frame>
...
9. Agora você pode utilizar o bloco `Coleção 1` em qualquer página do seu site.
   <Frame><img width="1504" alt="imagem" src="https://github.com/deco-cx/apps/assets/76620866/083981f5-b9ad-4d7c-af6f-f6060df1a71b"/></Frame>
