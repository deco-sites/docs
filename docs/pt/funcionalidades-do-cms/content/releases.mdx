...
<Frame><img width="640" alt="Tela de Releases e envs" src="/docs/cms-capabilities/releases/releases1.png"/></Frame>
...
<Frame><img width="480" alt="Estado do ambiente" src="/docs/cms-capabilities/releases/releases2.png"/></Frame>
...
<Frame><img width="640" alt="Exemplo de operações de releases" src="/docs/cms-capabilities/releases/releases3.png"/></Frame>
