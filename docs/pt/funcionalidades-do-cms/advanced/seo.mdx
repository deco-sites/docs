...
<Frame><img width="640" alt="Configuração de SEO" src="/docs/cms-capabilities/seo/seo1.png"/></Frame>
...
<Frame><img width="320" alt="Robots.txt" src="/docs/cms-capabilities/seo/seo2.png"/></Frame>
