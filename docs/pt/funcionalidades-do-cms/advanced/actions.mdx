...
<Frame><img width="640" alt="Listagem de Actions" src="/docs/cms-capabilities/actions/actions1.png"/></Frame>
...
<Frame><img width="640" alt="Visualização de uma action" src="/docs/cms-capabilities/actions/actions2.png"/></Frame>
...
<Frame><img width="320" alt="Criando uma action" src="/docs/cms-capabilities/actions/actions3.png"/></Frame>
