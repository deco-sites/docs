...
<Frame><img width="640" alt="Arquitetura Deployment" src="/images/self-host/architecture.png"/></Frame>
...
<Frame><img width="640" alt="Arquitetura Self-host site" src="/images/self-host/self-host-site.png"/></Frame>
...
<Frame><img width="640" alt="Arquitetura Self-host de Site e Envs" src="/images/self-host/self-host-envs.png"/></Frame>
