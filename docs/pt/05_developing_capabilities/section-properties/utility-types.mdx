...
- [Conceitos: Section](https://docs.deco.cx/pt/concepts/section)
- [Codificando uma nova Section](https://docs.deco.cx/pt/developing-guide/hello-world)

Você já sabe que é fácil criar uma [Section](https://docs.deco.cx/pt/concepts/section)
...
<Frame><img width="640" alt="Formulário da Section no Admin" src="/images/dev-capabilities/utility-types/section-form.png"/></Frame>
...
<Frame><img width="640" alt="Formulário da Section com label e descrição costumizadas" src="/images/dev-capabilities/utility-types/label-and-description.png"/></Frame>
...
isso
[na documentação de Annotations](https://docs.deco.cx/pt/developing-capabilities/section-properties/annotations).
