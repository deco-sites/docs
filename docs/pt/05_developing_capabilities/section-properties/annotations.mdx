...
<Frame><img src="/images/annotations/example.png" alt="Example" width="400"/></Frame>
...
<Frame><img src="/images/annotations/color2.png" alt="@format color example" width="300"/></Frame>

- `@format date`: Renderiza um input de data no lugar de um de texto.

<Frame><img src="/images/annotations/date.png" alt="@format date example" width="300"/></Frame>

- `@format html`: Renderiza um input que abre um Editor WYSIWYG para edição
  avançada do texto por html.

<Frame><img src="/images/widgets/html-open.png" alt="@format html example" width="300"/></Frame>
...
<Frame><img src="/images/annotations/mustache.png" alt="mustache example" width="300"/></Frame>
