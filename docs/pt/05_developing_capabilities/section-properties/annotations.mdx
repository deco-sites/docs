...
[dynamic options](https://deco.cx/docs/pt/developing-capabilities/section-properties/widgets#dynamic-options),
[button group](https://deco.cx/docs/pt/developing-capabilities/section-properties/widgets#button-group)
e
[icon select](https://deco.cx/docs/pt/developing-capabilities/section-properties/widgets#icon-select).
