...
![Código da Seção Hero](https://deco.cx/docs/editable-section/hero-section-code.png)
...
![Editando propriedades da Seção Hero](https://deco.cx/docs/editable-section/section-props.png)
...
![Exemplo de Botão CTA](https://deco.cx/docs/editable-section/cta-button-example.png)
...
![Ajuste de Tamanho do Botão CTA](https://deco.cx/docs/editable-section/cta-button-size-adjustment.gif)
