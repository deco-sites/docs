...
![Requisições da versão HTMX](https://deco.cx/docs/developing-guide/htmx/htmx-network.gif)

![Requisições da versão Preact](https://deco.cx/docs/developing-guide/htmx/preact-network.gif)
