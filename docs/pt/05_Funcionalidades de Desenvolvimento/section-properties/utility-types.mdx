...
<Frame><img width="640" alt="Formulário da Section no Admin" src="/docs/dev-capabilities/utility-types/section-form.png"/></Frame>
...
<Frame><img width="640" alt="Formulário da Section com label e descrição costumizadas" src="/docs/dev-capabilities/utility-types/label-and-description.png"/></Frame>
