...
Ao carregar dados de APIs externas usando [Loaders](https://docs.deco.cx/pt/concepts/loader) e
enviá-los para a [Section](https://docs.deco.cx/pt/concepts/section), é possível que o tamanho
...
<Frame><img width="640" alt="Informações de performance de uma página" src="/images/performance/performance-tab.png"/></Frame>
