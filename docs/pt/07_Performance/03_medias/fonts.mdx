...
<Frame><img width="640" alt="Configuração do tema com fontes" src="/images/performance/theme-font.png"/></Frame>
...
<Frame><img width="320" alt="Uso de temas próprios" src="/images/performance/custom-font.png"/></Frame>
