...
- [Conceitos da deco: Entendendo Seções](https://docs.deco.cx/pt/concepts/section)
- [Buscando Dados de APIs](https://docs.deco.cx/pt/developing-guide/fetching-data)
- [Invocação de Funções no Lado do Cliente](https://docs.deco.cx/pt/developing-capabilities/islands/fetching-data-client)
