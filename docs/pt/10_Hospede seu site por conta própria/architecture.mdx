...
<Frame><img width="640" alt="Arquitetura Deployment" src="/docs/self-host/architecture.png"/></Frame>
...
<Frame><img width="640" alt="Arquitetura Self-host site" src="/docs/self-host/self-host-site.png"/></Frame>
...
<Frame><img width="640" alt="Arquitetura Self-host de Site e Envs" src="/docs/self-host/self-host-envs.png"/></Frame>
