...
<Frame><img alt="Componente image como uma imagem de produto" src="/docs/image-aspect-ratio.png"/></Frame>

- `<Picture>` define imagens que podem variar de tamanho de acordo com a
  resolução de tela.

<Frame><img alt="Componente de Picture como uma imagem de banner" src="/docs/picture-aspect-ratio.png"/></Frame>
...
3. Passe o mouse sobre a tag da imagem. Você deverá ver algo como:
   <Frame><img alt="Propriedades da imagem no inspetor do navegador" src="/docs/width-attribute.png" /></Frame>
