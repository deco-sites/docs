...
<Frame><img width="640" alt="Configuração do tema com fontes" src="/docs/performance/theme-font.png"/></Frame>
...
<Frame><img width="320" alt="Uso de temas próprios" src="/docs/performance/custom-font.png"/></Frame>
