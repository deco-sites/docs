...
![Página de Seções](https://deco.cx/docs/getting-started/adding-an-app/sections-page.png)
...
2. **Valor Padrão**: Deixe o campo de temperatura em branco. A seção aceita um
   ...
   ![Valor Padrão](https://deco.cx/docs/getting-started/adding-an-app/default-value.png)
