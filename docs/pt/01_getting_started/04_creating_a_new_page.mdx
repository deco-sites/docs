...
![Space de páginas](https://deco.cx/docs/getting-started/creating-a-new-page/pages-space.png)
...
![Criando uma nova página](https://deco.cx/docs/getting-started/creating-a-new-page/new-page.png)
...
![Adicionando uma seção](https://deco.cx/docs/getting-started/creating-a-new-page/add-section.png)
...
![Seção Hero](https://deco.cx/docs/getting-started/creating-a-new-page/hero.png)
...
![Formulário da Seção](https://deco.cx/docs/getting-started/creating-a-new-page/section-form.png)
...
![Mudando a Seção](https://deco.cx/docs/getting-started/creating-a-new-page/changing-section.png)
