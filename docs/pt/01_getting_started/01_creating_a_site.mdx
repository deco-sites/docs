...
![Escolhendo um template](/images/getting-started/creating-site/choose-template.png)
...
![Editar um site](/images/getting-started/creating-site/site-editor.png)
...
![Salvar site para sua equipe](/images/getting-started/creating-site/save-site-btn.png)
...
![Escolhendo um nome e uma equipe para salvar o site](/images/getting-started/creating-site/save-site.png)

Se você ainda não tiver uma equipe, uma será criada com um nome à sua escolha:

![Escolhendo um nome e uma equipe que você vai criar](/images/getting-started/creating-site/save-site-and-team.png)
...
![Página Inicial do Site](/images/getting-started/creating-site/site-home.png)
...
1. Clique no botão "New" no dropdown de ambientes no Admin.
   ![Botão Novo Ambiente](/images/getting-started/creating-site/new-env-btn.png)
2. Escolha um nome e um host para o seu ambiente. Como não vamos rodar o site
   localmente, selecione a opção Web para o host.
   ![Formulário Novo Ambiente](/images/getting-started/creating-site/new-env-form.png)
...
<Frame><img src="/images/getting-started/creating-site/go-live-btn.png" alt="Botão de Deploy do site" width="340"/></Frame>
