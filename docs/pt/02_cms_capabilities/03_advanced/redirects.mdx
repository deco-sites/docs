...
<Frame><img width="640" alt="Redirects view" src="/images/cms-capabilities/redirects/redirects1.png"/></Frame>
...
<Frame><img width="320" alt="Add redirect form" src="/images/cms-capabilities/redirects/redirects2.png"/></Frame>
...
<Frame><img width="480" alt="Configure site app" src="/images/cms-capabilities/redirects/proxies1.png"/></Frame>

### 2. Procure peloRoutes Map

Procure no formulário de edição do app, pela propriedade de routes map.

<Frame><img width="320" alt="Configure site app" src="/images/cms-capabilities/redirects/proxies2.png"/></Frame>
