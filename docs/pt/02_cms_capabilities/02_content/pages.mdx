...
<Frame><img width="640" alt="Listagem de páginas" src="/images/cms-capabilities/pages/pages1.png"/></Frame>

Uma **Page** é um bloco fundamental na criação de um Site _deco.cx_ que
normalmente terá várias Pages. Cada `Page` consiste em:

- **uma ou mais [Sections](https://docs.deco.cx/pt/concepts/section)** configuradas, que podem
...
<Frame><img width="640" alt="Ações extras" src="/images/cms-capabilities/pages/pages2.png"/></Frame>
...
<Frame><img width="320" alt="Adicionar uma nova section" src="/images/cms-capabilities/pages/pages3.png"/></Frame>
...
<Frame><img width="640" alt="Biblioteca de sections" src="/images/cms-capabilities/pages/pages4.png"/></Frame>
...
<Frame><img width="640" alt="Biblioteca de sections" src="/images/cms-capabilities/pages/pages4-1.png"/></Frame>
...
<Frame><img width="320" alt="Biblioteca de sections" src="/images/cms-capabilities/pages/pages4-2.png"/></Frame>
...
<Frame><img width="320" alt="Configuração de uma condição" src="/images/cms-capabilities/pages/pages4-3.png"/></Frame>
...
<Frame><img width="640" alt="Biblioteca de sections" src="/images/cms-capabilities/pages/pages-seo.png"/></Frame>
...
<Frame><img width="320" alt="Ambiente e publicação" src="/images/cms-capabilities/pages/pages5.png"/></Frame>
...
<Frame><img width="320" alt="Criando uma variante" src="/images/cms-capabilities/pages/pages6.png"/></Frame>
...
<Frame><img width="320" alt="Criando uma variante" src="/images/cms-capabilities/pages/pages7.png"/></Frame>
