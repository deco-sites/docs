...
<Frame><img width="640" alt="TS to props" src="/images/overview/tstoprops.png"/></Frame>
...
<Frame><img width="640" alt="TS to props" src="/images/overview/analytics.png"/></Frame>
...
<Frame><img width="640" alt="TS to props" src="/images/overview/stack.png"/></Frame>
...
- [Getting started](https://docs.deco.cx/en/getting-started/creating-a-site): Take your first
  steps with deco! Learn about our CMS and the basic concepts.
- [Developing Guide](https://docs.deco.cx/en/developing-guide/setup): Learn how to program your
  site using our framework.
- [CMS Capabilities](https://docs.deco.cx/en/cms-capabilities/home): Explore what our CMS can
  do beyond the basics.
- [Dev Capabilities](https://docs.deco.cx/en/developing-capabilities/blocks): Find references
