...
![Selecting the site app](https://deco.cx/docs/gtm/select-app.png)

Next, locate the global sections properties:

![Global Sections](https://deco.cx/docs/gtm/global-sections.png)

Finally, add the Analytics section:

![Adding Analytics section](https://deco.cx/docs/gtm/add-analytics.png)
...
![Configuring your section](https://deco.cx/docs/gtm/configure-your-section.png)
