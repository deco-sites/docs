...
![Choosing a template](https://deco.cx/docs/getting-started/creating-site/choose-template.png)
...
![Edit a site](https://deco.cx/docs/getting-started/creating-site/site-editor.png)
...
![Save site to your team](https://deco.cx/docs/getting-started/creating-site/save-site-btn.png)
...
![Choosing a name and a team to save site](https://deco.cx/docs/getting-started/creating-site/save-site.png)

If you do not have a team yet, one will be created with a name of your choice:

![Choosing a name and a team that you'll create](https://deco.cx/docs/getting-started/creating-site/save-site-and-team.png)
...
![Site Home](https://deco.cx/docs/getting-started/creating-site/site-home.png)
...
1. Click on the "New" button in the environment dropdown in the Admin.
   ![New Environment button](https://deco.cx/docs/getting-started/creating-site/new-env-btn.png)
2. Choose a name and a host for your environment. Since we are not going to run
   ...
   ![New Environment Form](https://deco.cx/docs/getting-started/creating-site/new-env-form.png)
...
<Frame><img src="https://deco.cx/docs/getting-started/creating-site/go-live-btn.png" alt="Deploy site button" width="340"/></Frame>
