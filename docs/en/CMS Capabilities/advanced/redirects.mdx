...
<Frame><img width="640" alt="Redirects view" src="/docs/cms-capabilities/redirects/redirects1.png"/></Frame>
...
<Frame><img width="320" alt="Add redirect form" src="/docs/cms-capabilities/redirects/redirects2.png"/></Frame>
...
<Frame><img width="480" alt="Configure site app" src="/docs/cms-capabilities/redirects/proxies1.png"/></Frame>

### 2. Look for the Routes Map

Look for the routes map property in the app's editing form.

<Frame><img width="320" alt="Configure site app" src="/docs/cms-capabilities/redirects/proxies2.png"/></Frame>
