...
flexibility to create [Sections](https://deco.cx/docs/en/concepts/section) and
[Loaders](https://deco.cx/docs/en/concepts/loader) that meet their unique needs. To help you
...
[Creating a Site tutorial](https://deco.cx/docs/en/getting-started/creating-a-site).
...
![Adding collaborator to the repository](https://deco.cx/docs/setup/repository-access.png)
...
![Create new environment](https://deco.cx/docs/setup/create-environment.png)

#### 3.2 Set a name and a host to your environment

Choose a name for your environment and set your host as localhost.

![Choosing environment and starting server](https://deco.cx/docs/setup/choose-host.png)
...
![Start server command](https://deco.cx/docs/setup/start-server-command.png)

![Execute command on terminal](https://deco.cx/docs/setup/start-server-terminal.png)
...
![Publish changes](https://deco.cx/docs/setup/publish-button.png)
