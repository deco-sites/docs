...
[setup](https://deco.cx/docs/en/developing-guide/setup). By selecting your local environment in
the Admin, you can view the new Section in the Sections library (**Sections**)
and add it to a page.

![New section in the section library](https://deco.cx/docs/hello-world/new-section.png)
...
more about
[these annotations here](https://deco.cx/docs/en/developing-capabilities/section-properties/widgets).
...
![Section properties form in the admin](https://deco.cx/docs/hello-world/section-properties.png)
...
![Changing theme colors](https://deco.cx/docs/hello-world/themes.png)
...
![Choosing the page theme](https://deco.cx/docs/hello-world/add-section.png)

![Changing the page theme](https://deco.cx/docs/hello-world/section-themes.png)
...
![Adding the Groovy Vibes theme](https://deco.cx/docs/hello-world/page-theme.png)
...
![Section with site theme](https://deco.cx/docs/hello-world/new-section-with-theme.png)
