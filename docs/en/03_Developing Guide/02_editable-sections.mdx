...
you created in a [previous tutorial](https://deco.cx/docs/en/getting-started/creating-a-site).
...
![Hero Section Code](https://deco.cx/docs/editable-section/hero-section-code.png)
...
![Editing properties of the Hero Section](https://deco.cx/docs/editable-section/section-props.png)

**Section and its properties types**

## 2. Run your site locally

Follow the [environment configuration](https://deco.cx/docs/en/developing-guide/setup) steps
...
[Widget documentation](https://deco.cx/docs/en/developing-capabilities/section-properties/widgets).

Let's add a CTA button in our Hero section to see the modification:

![CTA Button Example](https://deco.cx/docs/editable-section/cta-button-example.png)

Now the CTA has the size field:

![CTA Size Field](https://deco.cx/docs/editable-section/cta-size-field.png)
...
![CTA Button Size Adjustment](https://deco.cx/docs/editable-section/cta-button-size-adjustment.gif)
