...
that into a Section using [Loaders](https://docs.deco.cx/en/concepts/loader).
...
- [Standard data types](https://docs.deco.cx/en/developing-capabilities/section-properties/standard-data-types)
- [Core Concepts: Loaders](https://docs.deco.cx/en/concepts/loader)
