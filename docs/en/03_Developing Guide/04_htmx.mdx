...
![HTMX installation in the deco Admin](https://deco.cx/docs/developing-guide/htmx/htmx-installation.png)
...
That's when the [`useSection` hook](https://deco.cx/docs/en/api-reference/use-section) comes in
...
![HTMX request in the network tab](https://deco.cx/docs/developing-guide/htmx/htmx-network.gif)

![Preact request in the network tab](https://deco.cx/docs/developing-guide/htmx/preact-network.gif)
