...
<Frame><img width="640" alt="Deployment Architecture" src="/docs/self-host/architecture.png"/></Frame>
...
<Frame><img width="640" alt="Self-host Site Architecture" src="/docs/self-host/self-host-site.png"/></Frame>
...
<Frame><img width="640" alt="Self-host Site and Envs Architecture" src="/docs/self-host/self-host-envs.png"/></Frame>
