...
<Frame><img src="/docs/annotations/example.png" alt="Example" width="400"/></Frame>
...
<Frame><img src="/docs/annotations/color2.png" alt="@format color example" width="300"/></Frame>

- `@format date`: Renders a date input instead of a text input.

<Frame><img src="/docs/annotations/date.png" alt="@format date example" width="300"/></Frame>

- `@format html`: Renders an input that opens a WYSIWYG editor for advanced HTML
  text editing.

<Frame><img src="/docs/widgets/html-open.png" alt="@format html example" width="300"/></Frame>
...
<Frame><img src="/docs/annotations/mustache.png" alt="mustache example" width="300"/></Frame>
