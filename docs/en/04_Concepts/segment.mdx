...
Segments are defined by [Matchers](https://docs.deco.cx/en/concepts/matchers), which evaluate
...
context of [Variants](https://docs.deco.cx/en/getting-started/variants). Variants enable you to
