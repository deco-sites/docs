...
![Database view in admin panel](https://deco.cx/docs/reference/deco-records/records-view.webp)
...
![Visualization of the generate credentials button](https://deco.cx/docs/reference/deco-records/generate-credentials.webp)
...
![Visualization of deco records tables](https://deco.cx/docs/reference/deco-records/records-view-tables.webp)
