...
<Frame><img alt="Image component as a product image" src="/docs/image-aspect-ratio.png"/></Frame>

- `<Picture>` defines images that can vary in size according to the screen
  resolution.

<Frame><img alt="Picture component as a banner image" src="/docs/picture-aspect-ratio.png"/></Frame>
...
3. Hover over the image tag. You should see something like:
   <Frame><img alt="Image properties in the browser inspector" src="/docs/width-attribute.png" /></Frame>
