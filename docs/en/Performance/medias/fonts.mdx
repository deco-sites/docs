...
<Frame><img width="640" alt="Theme configuration with fonts" src="/docs/performance/theme-font.png"/></Frame>
...
<Frame><img width="320" alt="Using custom fonts" src="/docs/performance/custom-font.png"/></Frame>
