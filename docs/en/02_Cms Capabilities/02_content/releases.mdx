...
<Frame><img width="640" alt="Releases and environments screen" src="https://deco.cx/docs/cms-capabilities/releases/releases1.png"/></Frame>
...
<Frame><img width="480" alt="Environment state" src="https://deco.cx/docs/cms-capabilities/releases/releases2.png"/></Frame>
...
<Frame><img width="640" alt="Example of releases operations" src="https://deco.cx/docs/cms-capabilities/releases/releases3.png"/></Frame>
...
<Frame><img width="640" alt="Biblioteca de sections" src="https://deco.cx/docs/cms-capabilities/releases/releases5.png"/></Frame>
...
<Frame><img width="640" alt="Lista de releases" src="https://deco.cx/docs/cms-capabilities/releases/releases4.png"/></Frame>
