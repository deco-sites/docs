...
[setup](https://docs.deco.cx/en/developing-guide/setup). By selecting your local environment in
the Admin, you can view the new Section in the Sections library (**Sections**)
and add it to a page.

![New section in the section library](/images/hello-world/new-section.png)
...
more about
[these annotations here](https://docs.deco.cx/en/developing-capabilities/section-properties/widgets).
...
![Section properties form in the admin](/images/hello-world/section-properties.png)
...
![Changing theme colors](/images/hello-world/themes.png)
...
![Choosing the page theme](/images/hello-world/add-section.png)

![Changing the page theme](/images/hello-world/section-themes.png)
...
![Adding the Groovy Vibes theme](/images/hello-world/page-theme.png)
...
![Section with site theme](/images/hello-world/new-section-with-theme.png)
