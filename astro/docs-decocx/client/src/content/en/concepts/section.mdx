...
possible to [Install Apps](https://docs.deco.cx/en/getting-started/installing-an-app).
...
- [Tutorial: Coding a new Section](https://docs.deco.cx/en/developing-guide/hello-world)
- [Developing: Editable sections](https://docs.deco.cx/en/developing-guide/editable-sections)
