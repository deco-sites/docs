...
![Environment Changes](/images/getting-started/changing-and-publishing/env-changes.png)
...
![Rebase environment](/images/getting-started/changing-and-publishing/rebase.png)
