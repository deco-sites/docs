...
![Database view in admin panel](/images/reference/deco-records/records-view.webp)
...
![Visualization of the generate credentials button](/images/reference/deco-records/generate-credentials.webp)
...
![Visualization of deco records tables](/images/reference/deco-records/records-view-tables.webp)
...
[section](https://docs.deco.cx/pt/concepts/section) to manage profiles, where we
