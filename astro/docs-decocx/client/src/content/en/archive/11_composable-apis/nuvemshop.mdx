...
![Creating the Website on deco.cx](https://github.com/deco-cx/apps/assets/76620866/f94bbf9a-e109-43a7-87ad-5ffd94c1701b)
...
3. Select the **Nuvemshop** App. You will se something like:
   ![image](https://github.com/deco-cx/apps/assets/76620866/5a52d192-cb60-4f84-9be6-9dcc00a1056e)
...
5. After that, you will se a button to get your Store Id and Access Token. Click
   ...
   panel.
   ![image](https://github.com/deco-cx/apps/assets/76620866/761ccfa2-074f-40c7-a40d-0e7852ea1341)

6. You will see a Pop-up like this:
   ![image](https://github.com/deco-cx/apps/assets/76620866/2dd205f5-8f76-42f0-b596-dea45ebaad0f)

7. Click on `Accept and start using`.

8. Finally, you will be redirected to a screen with the Store Id and Access
   Token:
   ![image](https://github.com/deco-cx/apps/assets/76620866/56b33ede-5d5e-4ef5-a307-421bb0f06c7b)
...
3. Select the `ProductShelf` block and click on the `+` button.
   ![image](https://github.com/deco-cx/apps/assets/76620866/cbd54a38-3caf-431f-aeaf-b8eb2548626e)

4. In the `products` field, select the Nuvemshop integration.
   ![image](https://github.com/deco-cx/apps/assets/76620866/70bf9588-adea-41ee-b87f-ba62b986d057)
