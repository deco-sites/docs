...
![Criando um website no deco.cx](https://github.com/deco-cx/apps/assets/76620866/0fadbdad-a892-4a9c-bd1a-a0ed9d09bfee)
...
4. Selecione o App **shopify.ts** e clique no bloco shopify. Você verá algo
   como:
   ![imagem](https://github.com/deco-sites/starting/assets/76620866/a4127f6a-9d8f-4d27-b639-3a30db761e44)
...
3. Selecione o bloco `/Products/ProductShelf.tsx` e clique no botão `+`.
   ![imagem](https://github.com/deco-sites/starting/assets/1753396/a2bfe995-daf1-4ef7-8957-2bc55712ec87)

4. No campo `products`, selecione a integração Shopify.
   ![imagem](https://github.com/deco-sites/starting/assets/76620866/9dac417e-fbf7-4fd2-b474-6dd463c5887a)
...
6. Preencha o atributo `count` com o número de produtos a serem exibidos,
   digamos 4.
   ![imagem](https://github.com/deco-sites/starting/assets/76620866/648b7b2a-94ca-49c0-bf72-ce7afa683282)

7. Agora, no canto superior direito, clique em `Criar` e dê um nome, por
   exemplo, `Coleção 139`.
   ![imagem](https://github.com/deco-sites/starting/assets/1753396/97720584-3206-4457-8972-a719323962c4)

8. No canto superior direito, clique em `Publicar`.
9. Agora você pode arrastar e soltar o bloco `Coleção 139` em qualquer página.
   ![imagem](https://github.com/deco-sites/starting/assets/76620866/114aa43e-f727-45db-99e2-b7f4b7d6c7a1)
