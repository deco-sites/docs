...
criou em um [tutorial anterior](https://docs.deco.cx/pt/getting-started/creating-a-site).
...
![Código da Seção Hero](/images/editable-section/hero-section-code.png)
...
![Editando propriedades da Seção Hero](/images/editable-section/section-props.png)

**Seção e seus tipos de propriedades**

## 2. Execute seu site localmente

Siga os passos de [configuração do ambiente](https://docs.deco.cx/pt/developing-guide/setup) e
...
[documentação de Widgets](https://docs.deco.cx/pt/developing-capabilities/section-properties/widgets).

Vamos adicionar um botão CTA na nossa seção Hero para ver a modificação:

![Exemplo de Botão CTA](/images/editable-section/cta-button-example.png)

Agora o CTA tem o campo de tamanho:

![Campo de Tamanho do CTA](/images/editable-section/cta-size-field.png)
...
![Ajuste de Tamanho do Botão CTA](/images/editable-section/cta-button-size-adjustment.gif)
