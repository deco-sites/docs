...
![Space de páginas](/images/getting-started/creating-a-new-page/pages-space.png)
...
![Criando uma nova página](/images/getting-started/creating-a-new-page/new-page.png)
...
![Adicionando uma seção](/images/getting-started/creating-a-new-page/add-section.png)

> Se você deseja desenvolver/codar uma nova seção, consulte nosso
> [Guia de desenvolvimento](https://docs.deco.cx/pt/developing-guide/setup).

Vamos selecionar a seção Hero.

![Seção Hero](/images/getting-started/creating-a-new-page/hero.png)
...
![Formulário da Seção](/images/getting-started/creating-a-new-page/section-form.png)
...
![Mudando a Seção](/images/getting-started/creating-a-new-page/changing-section.png)
